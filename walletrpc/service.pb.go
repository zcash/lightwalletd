...
var file_service_proto_rawDesc = []byte{
	...
	0x78, 0x69, 0x74, 0x22, 0x23, 0x0a, 0x07, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x18,
	0x0a, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0x27, 0x0a, 0x0b, 0x41, 0x64, 0x64, 0x72,
	0x65, 0x73, 0x73, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65,
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x5a, 0x61, 0x74, 0x32, 0xa8, 0x07, 0x0a, 0x11, 0x43, 0x6f, 0x6d,
	...
	,
	...
	0x12, 0x5d, 0x0a, 0x17, 0x47, 0x65, 0x74, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x42, 0x61,
	...
	0x65, 0x22, 0x00, 0x42, 0x10, 0x5a, 0x0b, 0x2e, 0x3b, 0x77, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x72,
...
var file_service_proto_depIdxs = []int32{
	...
	12, // 10: cash.z.wallet.sdk.rpc.CompactTxStreamer.GetAddressBalance:input_type -> cash.z.wallet.sdk.rpc.AddressList
	11, // 11: cash.z.wallet.sdk.rpc.CompactTxStreamer.GetAddressBalanceStream:input_type -> cash.z.wallet.sdk.rpc.Address
	...
	3,  // 19: cash.z.wallet.sdk.rpc.CompactTxStreamer.GetAddressTxids:output_type -> cash.z.wallet.sdk.rpc.RawTransaction
	13, // 20: cash.z.wallet.sdk.rpc.CompactTxStreamer.GetAddressBalance:output_type -> cash.z.wallet.sdk.rpc.Balance
	13, // 21: cash.z.wallet.sdk.rpc.CompactTxStreamer.GetAddressBalanceStream:output_type -> cash.z.wallet.sdk.rpc.Balance
...
type CompactTxStreamerClient interface {
	...
	GetAddressBalance(ctx context.Context, in *AddressList, opts ...grpc.CallOption) (*Balance, error)
	GetAddressBalanceStream(ctx context.Context, opts ...grpc.CallOption) (CompactTxStreamer_GetAddressBalanceStreamClient, error)
...
func (c *compactTxStreamerClient) GetAddressBalance(ctx context.Context, in *AddressList, opts ...grpc.CallOption) (*Balance, error) {
	out := new(Balance)
	err := c.cc.Invoke(ctx, "/cash.z.wallet.sdk.rpc.CompactTxStreamer/GetAddressBalance", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *compactTxStreamerClient) GetAddressBalanceStream(ctx context.Context, opts ...grpc.CallOption) (CompactTxStreamer_GetAddressBalanceStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &_CompactTxStreamer_serviceDesc.Streams[2], "/cash.z.wallet.sdk.rpc.CompactTxStreamer/GetAddressBalanceStream", opts...)
	if err != nil {
		return nil, err
	}
	x := &compactTxStreamerGetAddressBalanceStreamClient{stream}
	return x, nil
}

type CompactTxStreamer_GetAddressBalanceStreamClient interface {
	Send(*Address) error
	CloseAndRecv() (*Balance, error)
	grpc.ClientStream
}

type compactTxStreamerGetAddressBalanceStreamClient struct {
	grpc.ClientStream
}

func (x *compactTxStreamerGetAddressBalanceStreamClient) Send(m *Address) error {
	return x.ClientStream.SendMsg(m)
}

func (x *compactTxStreamerGetAddressBalanceStreamClient) CloseAndRecv() (*Balance, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(Balance)
...
type CompactTxStreamerServer interface {
	...
	GetAddressBalance(context.Context, *AddressList) (*Balance, error)
	GetAddressBalanceStream(CompactTxStreamer_GetAddressBalanceStreamServer) error
	// Return information about this lightwalletd instance and the blockchain
...
func (*UnimplementedCompactTxStreamerServer) GetAddressBalance(context.Context, *AddressList) (*Balance, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAddressBalance not implemented")
}
func (*UnimplementedCompactTxStreamerServer) GetAddressBalanceStream(CompactTxStreamer_GetAddressBalanceStreamServer) error {
	return status.Errorf(codes.Unimplemented, "method GetAddressBalanceStream not implemented")
}
...
func _CompactTxStreamer_GetAddressBalance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AddressList)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CompactTxStreamerServer).GetAddressBalance(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cash.z.wallet.sdk.rpc.CompactTxStreamer/GetAddressBalance",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CompactTxStreamerServer).GetAddressBalance(ctx, req.(*AddressList))
	}
	return interceptor(ctx, in, info, handler)
}

func _CompactTxStreamer_GetAddressBalanceStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CompactTxStreamerServer).GetAddressBalanceStream(&compactTxStreamerGetAddressBalanceStreamServer{stream})
}

type CompactTxStreamer_GetAddressBalanceStreamServer interface {
	SendAndClose(*Balance) error
	Recv() (*Address, error)
	grpc.ServerStream
}

type compactTxStreamerGetAddressBalanceStreamServer struct {
	grpc.ServerStream
}

func (x *compactTxStreamerGetAddressBalanceStreamServer) SendAndClose(m *Balance) error {
	return x.ServerStream.SendMsg(m)
}

func (x *compactTxStreamerGetAddressBalanceStreamServer) Recv() (*Address, error) {
	m := new(Address)
...
var _CompactTxStreamer_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _CompactTxStreamer_GetAddressBalance_Handler,
		},
		{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "GetAddressBalanceStream",
			Handler:       _CompactTxStreamer_GetAddressBalanceStream_Handler,
			ClientStreams: true,
		},
	},

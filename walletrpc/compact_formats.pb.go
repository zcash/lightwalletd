...
type CompactBlock struct {
	...
	Hash          []byte                 `protobuf:"bytes,3,opt,name=hash,proto3" json:"hash,omitempty"`                   // if present, the ID (hash) of this block
	PrevHash      []byte                 `protobuf:"bytes,4,opt,name=prevHash,proto3" json:"prevHash,omitempty"`           // if present, the ID (hash) of this block's predecessor
	Time          uint32                 `protobuf:"varint,5,opt,name=time,proto3" json:"time,omitempty"`                  // if non-zero, Unix epoch time when the block was mined
	Header        []byte                 `protobuf:"bytes,6,opt,name=header,proto3" json:"header,omitempty"`               // if present, full header (as returned by the getblock RPC)
...
const file_compact_formats_proto_rawDesc = "" +
	...
	"\x1aironwoodCommitmentTreeSize\x18\x03 \x01(\rR\x1aironwoodCommitmentTreeSize\"\x96\x02\n" +
	"\fCompactBlock\x12\x16\n" +
	...
	"\rchainMetadata\x18\b \x01(\v2$.cash.z.wallet.sdk.rpc.ChainMetadataR\rchainMetadataJ\x04\b\x01\x10\x02R\fprotoVersion\"\xd8\x03\n" +
	"\tCompactTx\x12\x14\n" +
	...
	"\aactions\x18\x06 \x03(\v2+.cash.z.wallet.sdk.rpc.CompactOrchardActionR\aactions\x12U\n" +
	"\x0fironwoodActions\x18\t \x03(\v2+.cash.z.wallet.sdk.rpc.CompactOrchardActionR\x0fironwoodActions\x124\n" +
...
var file_compact_formats_proto_depIdxs = []int32{
	...
	7, // 5: cash.z.wallet.sdk.rpc.CompactTx.ironwoodActions:type_name -> cash.z.wallet.sdk.rpc.CompactOrchardAction
	3, // 6: cash.z.wallet.sdk.rpc.CompactTx.vin:type_name -> cash.z.wallet.sdk.rpc.CompactTxIn
	4, // 7: cash.z.wallet.sdk.rpc.CompactTx.vout:type_name -> cash.z.wallet.sdk.rpc.TxOut

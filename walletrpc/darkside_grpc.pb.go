...
const (
	...
	DarksideStreamer_AddAddressTransaction_FullMethodName     = "/cash.z.wallet.sdk.rpc.DarksideStreamer/AddAddressTransaction"
	DarksideStreamer_ClearAddressTransactions_FullMethodName  = "/cash.z.wallet.sdk.rpc.DarksideStreamer/ClearAddressTransactions"
...
type DarksideStreamerClient interface {
	...
	// Add a (address, transaction, height) entry to be returned by GetTaddressTransactions.
	AddAddressTransaction(ctx context.Context, in *DarksideAddressTransaction, opts ...grpc.CallOption) (*Empty, error)
	// Clear the list of address transaction entries (can't fail)
	ClearAddressTransactions(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Empty, error)
...
func (c *darksideStreamerClient) AddAddressTransaction(ctx context.Context, in *DarksideAddressTransaction, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, DarksideStreamer_AddAddressTransaction_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *darksideStreamerClient) ClearAddressTransactions(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, DarksideStreamer_ClearAddressTransactions_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DarksideStreamerServer interface {
	...
	// Add a (address, transaction, height) entry to be returned by GetTaddressTransactions.
	AddAddressTransaction(context.Context, *DarksideAddressTransaction) (*Empty, error)
	// Clear the list of address transaction entries (can't fail)
	ClearAddressTransactions(context.Context, *Empty) (*Empty, error)
	// Adds a GetTreeState to the tree state cache
...
func (UnimplementedDarksideStreamerServer) StageBlocksStream(grpc.ClientStreamingServer[DarksideBlock, Empty]) error {
	return status.Error(codes.Unimplemented, "method StageBlocksStream not implemented")
}
func (UnimplementedDarksideStreamerServer) StageBlocks(context.Context, *DarksideBlocksURL) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method StageBlocks not implemented")
}
func (UnimplementedDarksideStreamerServer) StageBlocksCreate(context.Context, *DarksideEmptyBlocks) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method StageBlocksCreate not implemented")
}
func (UnimplementedDarksideStreamerServer) StageTransactionsStream(grpc.ClientStreamingServer[RawTransaction, Empty]) error {
	return status.Error(codes.Unimplemented, "method StageTransactionsStream not implemented")
}
func (UnimplementedDarksideStreamerServer) StageTransactions(context.Context, *DarksideTransactionsURL) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method StageTransactions not implemented")
}
func (UnimplementedDarksideStreamerServer) ApplyStaged(context.Context, *DarksideHeight) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method ApplyStaged not implemented")
}
func (UnimplementedDarksideStreamerServer) GetIncomingTransactions(*Empty, grpc.ServerStreamingServer[RawTransaction]) error {
	return status.Error(codes.Unimplemented, "method GetIncomingTransactions not implemented")
}
func (UnimplementedDarksideStreamerServer) ClearIncomingTransactions(context.Context, *Empty) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method ClearIncomingTransactions not implemented")
}
func (UnimplementedDarksideStreamerServer) AddAddressUtxo(context.Context, *GetAddressUtxosReply) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method AddAddressUtxo not implemented")
}
func (UnimplementedDarksideStreamerServer) ClearAddressUtxo(context.Context, *Empty) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method ClearAddressUtxo not implemented")
}
func (UnimplementedDarksideStreamerServer) AddAddressTransaction(context.Context, *DarksideAddressTransaction) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method AddAddressTransaction not implemented")
}
func (UnimplementedDarksideStreamerServer) ClearAddressTransactions(context.Context, *Empty) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method ClearAddressTransactions not implemented")
}
func (UnimplementedDarksideStreamerServer) AddTreeState(context.Context, *TreeState) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method AddTreeState not implemented")
}
func (UnimplementedDarksideStreamerServer) RemoveTreeState(context.Context, *BlockID) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method RemoveTreeState not implemented")
}
func (UnimplementedDarksideStreamerServer) ClearAllTreeStates(context.Context, *Empty) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method ClearAllTreeStates not implemented")
}
func (UnimplementedDarksideStreamerServer) SetSubtreeRoots(context.Context, *DarksideSubtreeRoots) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method SetSubtreeRoots not implemented")
}
...
func RegisterDarksideStreamerServer(s grpc.ServiceRegistrar, srv DarksideStreamerServer) {
	// If the following call panics, it indicates UnimplementedDarksideStreamerServer was
...
func _DarksideStreamer_AddAddressTransaction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DarksideAddressTransaction)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DarksideStreamerServer).AddAddressTransaction(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DarksideStreamer_AddAddressTransaction_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DarksideStreamerServer).AddAddressTransaction(ctx, req.(*DarksideAddressTransaction))
	}
	return interceptor(ctx, in, info, handler)
}

func _DarksideStreamer_ClearAddressTransactions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DarksideStreamerServer).ClearAddressTransactions(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DarksideStreamer_ClearAddressTransactions_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DarksideStreamerServer).ClearAddressTransactions(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DarksideStreamer_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AddAddressTransaction",
			Handler:    _DarksideStreamer_AddAddressTransaction_Handler,
		},
		{
			MethodName: "ClearAddressTransactions",
			Handler:    _DarksideStreamer_ClearAddressTransactions_Handler,
		},
		{

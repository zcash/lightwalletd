...
const (
	...
	DarksideStreamer_AddAddressTxid_FullMethodName            = "/cash.z.wallet.sdk.rpc.DarksideStreamer/AddAddressTxid"
	DarksideStreamer_ClearAddressTxids_FullMethodName         = "/cash.z.wallet.sdk.rpc.DarksideStreamer/ClearAddressTxids"
...
type DarksideStreamerClient interface {
	...
	// Add a (address, txid, height) entry to be returned by GetTaddressTxids.
	AddAddressTxid(ctx context.Context, in *DarksideAddressTxid, opts ...grpc.CallOption) (*Empty, error)
	// Clear the list of address txid entries (can't fail)
	ClearAddressTxids(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Empty, error)
...
func (c *darksideStreamerClient) AddAddressTxid(ctx context.Context, in *DarksideAddressTxid, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, DarksideStreamer_AddAddressTxid_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *darksideStreamerClient) ClearAddressTxids(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, DarksideStreamer_ClearAddressTxids_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DarksideStreamerServer interface {
	...
	// Add a (address, txid, height) entry to be returned by GetTaddressTxids.
	AddAddressTxid(context.Context, *DarksideAddressTxid) (*Empty, error)
	// Clear the list of address txid entries (can't fail)
	ClearAddressTxids(context.Context, *Empty) (*Empty, error)
	// Adds a GetTreeState to the tree state cache
...
func (UnimplementedDarksideStreamerServer) AddAddressTxid(context.Context, *DarksideAddressTxid) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddAddressTxid not implemented")
}
func (UnimplementedDarksideStreamerServer) ClearAddressTxids(context.Context, *Empty) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ClearAddressTxids not implemented")
}
...
func _DarksideStreamer_AddAddressTxid_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DarksideAddressTxid)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DarksideStreamerServer).AddAddressTxid(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DarksideStreamer_AddAddressTxid_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DarksideStreamerServer).AddAddressTxid(ctx, req.(*DarksideAddressTxid))
	}
	return interceptor(ctx, in, info, handler)
}

func _DarksideStreamer_ClearAddressTxids_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DarksideStreamerServer).ClearAddressTxids(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DarksideStreamer_ClearAddressTxids_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DarksideStreamerServer).ClearAddressTxids(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DarksideStreamer_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AddAddressTxid",
			Handler:    _DarksideStreamer_AddAddressTxid_Handler,
		},
		{
			MethodName: "ClearAddressTxids",
			Handler:    _DarksideStreamer_ClearAddressTxids_Handler,
		},
		{
